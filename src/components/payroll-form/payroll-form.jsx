...
import logo from 'F:/workspace/HTML CSS practice/assets/emp.jpg'
...
const PayrollForm = (props) => {
    let initialValue = {
        name: '',
        profileArray: [
            { url: 'F:/workspace/HTML CSS practice/assets/profile1.jpg' },
            { url: 'F:/workspace/HTML CSS practice/assets/profile2.jpg' },
            { url: 'F:/workspace/HTML CSS practice/assets/profile3.jpg' },
            { url: 'F:/workspace/HTML CSS practice/assets/profile4.jpg' }
                ...
                <form className="form" action="#" onSubmit={save}>
                    ...
                    <div className="row">
                        ...
                        <div className="profile-radio-button">
                            <label >
                                <input type="radio" checked={formValue.profileUrl === 'F:/workspace/HTML CSS practice/assets/profile1.jpg'} name="profileUrl" value="F:/workspace/HTML CSS practice/assets/profile1.jpg" onChange={changeValue} />
                                <img className="profile" src={profile1} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === 'F:/workspace/HTML CSS practice/assets/profile2.jpg'} value="F:/workspace/HTML CSS practice/assets/profile2.jpg" onChange={changeValue} />
                                <img className="profile" src={profile2} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === 'F:/workspace/HTML CSS practice/assets/profile3.jpg'} value="F:/workspace/HTML CSS practice/assets/profile3.jpg" onChange={changeValue} />
                                <img className="profile" src={profile3} alt="profile" />
                            </label>
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === 'F:/workspace/HTML CSS practice/assets/profile4.jpg'} value="F:/workspace/HTML CSS practice/assets/profile4.jpg" onChange={changeValue} />
